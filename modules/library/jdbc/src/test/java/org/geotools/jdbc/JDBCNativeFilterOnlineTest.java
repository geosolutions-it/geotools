...
public abstract class JDBCNativeFilterOnlineTest extends JDBCTestSupport {
    ...
    public void testNativeFilterExecution() throws Exception {
        ...
        BBOX boundingBoxFilter = filterFactory.bbox(
    ...
    /**
     * Builds a native filter that consider only the measurement of type temperature
     * and wind with a value superior to 15.0.
     */
