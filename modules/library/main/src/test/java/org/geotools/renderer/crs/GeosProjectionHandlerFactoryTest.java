...
public class GeosProjectionHandlerFactoryTest {
    ...
    public void testValidAreaEarth() throws Exception {
        // 5000 meters, that is, the satellite is sitting just above the earth surface, the height
        // of a mountain
    ...
    /**
     * Helper method to extract the envelopes of the geometries in a consistent order, for testing
     * purposes.
     */
