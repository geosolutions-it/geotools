...
public class PROJParsingTest {
    ...
    /**
     * Load the support EPSG Proj Definitions and get the PROJ String from each EPSG code. Check
    ...
    public void testExtensivePROJDefinitions() throws IOException, FactoryException {
        ...
        for (String epsgCode : projDefinitions.stringPropertyNames()) {
            ...
            String decodedProjString = formatter.toPROJ(crs);
            ...
            assertTrue(
                    "Mismatch for EPSG code: "
                            ...
                            + " \nactual="
                            + decodedProjString,
                    expectedProjString.equalsIgnoreCase(decodedProjString));
        }
