...
public class SingleStoreDataStoreFactoryTest {
    ...
    public void testCanProcess() throws Exception {
        ...
        params.put(JDBCDataStoreFactory.USER.key, "SingleStoreuser");
    ...
    public void testNoNpeOnConnectionFailure() throws Exception {
        ...
        try {
            factory.isSingleStoreVersion56OrAbove(store);
        } catch (NullPointerException e) {
            Assert.fail("an exception occured during checking of SingleStore version " + e);
        }
    }
}
