...
public class SingleStoreDialect extends SQLDialect {
    ...
    /** flag indicating we are using SingleStore v8.0 or higher. */
    protected boolean isSingleStoreVersion80OrAbove;
    ...
    public boolean isSingleStoreVersion80OrAbove() {
        return this.isSingleStoreVersion80OrAbove;
    }

    public void setSingleStoreVersion80OrAbove(boolean singleStoreVersion80OrAbove) {
        this.isSingleStoreVersion80OrAbove = singleStoreVersion80OrAbove;
    }
    ...
    public void encodeGeometryEnvelope(String tableName, String geometryColumn, StringBuffer sql) {
        if (this.usePreciseSpatialOps) {
            if (this.isSingleStoreVersion80OrAbove) {
