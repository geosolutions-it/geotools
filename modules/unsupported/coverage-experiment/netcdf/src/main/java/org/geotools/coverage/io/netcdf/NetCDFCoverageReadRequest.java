...
//    private Dimension tileDimensions;
    ...
    private void checkRequest(CoverageReadRequest request) throws IOException {
        ...
        // //
        Rectangle requestedRasterArea = request.getRasterArea();
        UnidataCoverageDescriptor.UnidataSpatialDomain horizontalDomain = (UnidataCoverageDescriptor.UnidataSpatialDomain)source.getSpatialDomain();
        UnidataCoverageDescriptor.UnidataTemporalDomain temporalDomain = (UnidataCoverageDescriptor.UnidataTemporalDomain) source.getTemporalDomain();
        UnidataCoverageDescriptor.UnidataVerticalDomain verticalDomain = (UnidataCoverageDescriptor.UnidataVerticalDomain) source.getVerticalDomain();
